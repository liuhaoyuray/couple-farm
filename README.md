...
- 修复真机云存储图片：头像、村庄/社区帖子图片统一换取并缓存临时可访问地址，失败时自动刷新
...
正式上线的低成本方案与容量边界见 [`docs/hosting-cost-0.4.md`](docs/hosting-cost-0.4.md)，支付暂缓，v0.8 上线、内容安全与真机验收见 [`release-assets/0.8.0-release-notes.md`](release-assets/0.8.0-release-notes.md)。
