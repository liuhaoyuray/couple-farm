...
正式上线的低成本方案与容量边界见 [`docs/hosting-cost-0.4.md`](docs/hosting-cost-0.4.md)，支付暂缓，v0.9 上线与真机验收见 [`release-assets/0.9.0-release-notes.md`](release-assets/0.9.0-release-notes.md)。
