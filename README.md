...
- 村口社区：文字/单图动态、每日话题与自愿公开的趣味数据卡
- 社区点赞、留言、关注、举报、屏蔽、限频和微信内容安全检查
...
- 事项可一键加入手机日历；微信订阅提醒入口已就绪，待公众平台模板配置后启用发送
- 村口读取降级保护：部分旧数据或集合异常时仍能打开，不再整页报错
- 心动会员内测：7 天创始体验、免费/会员权益门槛和付费意向登记（尚未接入扣费）
- 村口云端自检、集合初始化、空条件查询兼容和有界社区读取
...
正式上线的低成本方案与容量边界见 [`docs/hosting-cost-0.4.md`](docs/hosting-cost-0.4.md)，支付资质与提醒接入清单见 [`docs/v0.5-payment-and-reminders.md`](docs/v0.5-payment-and-reminders.md)。
