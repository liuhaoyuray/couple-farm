...
正式上线的低成本方案与容量边界见 [`docs/hosting-cost-0.4.md`](docs/hosting-cost-0.4.md)，支付暂缓，v0.7 上线与微信提醒验收见 [`release-assets/0.7.0-release-notes.md`](release-assets/0.7.0-release-notes.md)。
